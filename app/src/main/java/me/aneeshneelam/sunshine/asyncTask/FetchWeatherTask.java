...
public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
    ...
    protected String[] doInBackground(String... params) {
        ...
        try {
            ...
            forecastArray = getWeatherDataFromJson(buffer.toString(), numDays);
        } catch (IOException | JSONException e) {
            Log.e(LOG_TAG, "Error ", e);
            // If the code didn't successfully get the weather data or error occured when attempting to parse it.
            forecastArray = null;
        } finally {
    ...
    protected void onPostExecute(String[] forecastArray) {
        forecastFragment.onFetchWeatherTaskComplete(forecastArray);
    }
